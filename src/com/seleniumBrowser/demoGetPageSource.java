...
public class demoGetPageSource {
	...
	public static void main(String[] args) {
		...
		String currentUrl1 = driver1.getPageSource();
		...
		String currentUrl2 = driver2.getPageSource();
		...
		String currentUrl3 = driver3.getPageSource();
		...
		String currentUrl4 = driver4.getPageSource();
		...
		String currentUrl5 = driver5.getPageSource();
